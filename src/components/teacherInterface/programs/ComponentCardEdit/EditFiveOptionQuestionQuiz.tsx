...
function EditFiveOptionQuestion({ course, quiz, index, question }) 
{
        ...
        >
            ...
            >
                <Stack
                    ...
                    gap={1}
                >
                    <HighlightOffIcon onClick={() => queryClient.setQueryData(['quizEdit', quiz?.id ?? '', course.id], (oldData: unknown) => {
