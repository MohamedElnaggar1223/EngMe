...
// import { EditAssessmentContext } from './ComponentCardEditAssessment';
import { useQueryClient } from '@tanstack/react-query';

//@ts-expect-error anytype
// eslint-disable-next-line react-refresh/only-export-components
function EditOptionQuestion({ course, assessment, index, question }) 
{
        ...
        >
            ...
            >
                <Stack
                    ...
                    gap={1}
                >
                    <HighlightOffIcon onClick={() => queryClient.setQueryData(['assessmentEdit', assessment?.id ?? '', course.id], (oldData: unknown) => {
