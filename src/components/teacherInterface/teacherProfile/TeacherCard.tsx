        ...
        >
            ...
            >
                <img 
                    ...
                    src={userData?.image} width='250px' height='250px' alt='profile' 
                />
                <Stack
                    direction='column'
                    gap={1}
                ...
                >
                    ...
                    >
                        ...
                        <SvgIcon sx={{ fontSize: 20, marginLeft: 1, marginTop: -1, cursor: 'pointer' }}>
                    ...
                    <Typography
                        ...
                        fontWeight={400}
                    >
                    {userData?.title} | {userData?.university}
                    </Typography>
                </Stack>
            </Stack>
            <Stack
