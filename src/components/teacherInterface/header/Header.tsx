            ...
            >
                ...
                >
                    ...
                    {(popupState) => (
                        ...
                        <SvgIcon {...bindToggle(popupState)} sx={{ cursor: 'pointer', fontSize: 30, border: '1.5px solid', padding: 0.5, borderRadius: '6px', borderColor: '#6A9DBC' }}>
                        ...
                        <Popper style={{ zIndex: 99999, display: 'flex', alignItems: 'center' }} {...bindPopper(popupState)} transition>
                            ...
                            <Fade {...TransitionProps} timeout={150}>
                                <Paper onClick={() => handleSignOut()} sx={{ display: 'flex', alignItems: 'center', cursor: 'pointer', '&:hover': { bgcolor: '#fcfcfc' } }}>
                                    ...
                                    <Typography sx={{ pl: 1, pr: 6, pb: 1.5, pt: 1.8, alignSelf: 'flex-start' }}>Sign Out</Typography>
                                </Paper>
                            </Fade>
                            )}
                        </Popper>
