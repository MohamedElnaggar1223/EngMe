            ...
            >
                ...
                >
                    <Stack
                        ...
                        // px={8}
                    >
                        <Typography sx={{ color: '#fff' }} fontFamily='Inter' fontSize={16} fontWeight={500}>Quiz 1</Typography>
                    </Stack>
            ...
            <AccordionDetails sx={{ background: '#F8F8F8', paddingY: 0, paddingX: 0 }}>
                ...
                >
                    ...
                    <Stack
                        ...
                        flex={1}
                    >
                        <Typography fontFamily='Inter' fontSize={16} fontWeight={500}>First Take</Typography>
                    </Stack>
                    <Stack
                    ...
                    >
                        <Typography fontFamily='Inter' fontSize={16} fontWeight={500}>12/15</Typography>
                    </Stack>
                </Stack>
                <Stack
                    direction='row'
                ...
                >
                    ...
                    <Stack
                        ...
                        flex={1}
                    >
                        <Typography fontFamily='Inter' fontSize={16} fontWeight={500}>Retake</Typography>
                    </Stack>
                    <Stack
                        bgcolor='rgba(255, 255, 255, 0.80)'
                        height='100%'
                    ...
                    >
                        <Typography fontFamily='Inter' fontSize={16} fontWeight={500}>14.5/15</Typography>
                    </Stack>
                </Stack>
            </AccordionDetails>
        </Accordion>
