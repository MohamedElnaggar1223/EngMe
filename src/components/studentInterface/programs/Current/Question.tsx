...
export default function Question({ second }: T) 
{
    const icon = second ?
    (
        ...
        <Accordion sx={{ '.css-o4b71y-MuiAccordionSummary-content': { margin: 0, boxShadow: 'none' }, boxShadow: 'none', '.css-1g92jzo-MuiPaper-root-MuiAccordion-root': { boxShadow: 'none' } }}>
                ...
                >
                    ...
                    >
                        <Stack
                            ...
                            gap={8}
                        >
                            <SvgIcon sx={{ background: second ? '#E80505' : '#00C342', borderRadius: '50%' }}>
                                {icon}
                            </SvgIcon>
                            <Typography sx={{ color: '#fff' }} fontFamily='Inter' fontSize={16} fontWeight={500}>{second ? 'Second Question' : 'First Question' }</Typography>
                        </Stack>
                        <Typography sx={{ color: '#fff' }} fontFamily='Inter' fontSize={16} fontWeight={500}>3 Marks</Typography>
                    </Stack>
                </AccordionSummary>
                <AccordionDetails sx={{ background: '#F8F8F8', paddingY: 0, paddingX: 0 }}>
                    ...
                    <Stack
                        ...
                        bgcolor='#fff'
                    >
                        <Typography fontFamily='Inter' fontSize={14} fontWeight={500}>The fossils in Korea</Typography>
                    </Stack>
                    <Stack
                        direction='row'
                        justifyContent='space-between'
                        ...
                        bgcolor='#A0F4BD'
                    >
                        <Typography fontFamily='Inter' fontSize={14} fontWeight={500}>Noura Kamal</Typography>
                    </Stack>
                    <Stack
                        direction='row'
                        justifyContent='space-between'
                        ...
                        bgcolor='#FCD0D0'
                    >
                        <Typography fontFamily='Inter' fontSize={14} fontWeight={500}>Lucky Ancestors</Typography>
                    </Stack>
                </AccordionDetails>
            </Accordion>
        </Suspense>
