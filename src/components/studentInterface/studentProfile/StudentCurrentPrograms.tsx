...
export default function StudentCurrentPrograms() 
{
    return (
        ...
        >
            ...
            <CurrentCourseCard />
            <Accordion TransitionProps={{ unmountOnExit: true }} sx={{ '.css-97ovai': {borderRadius: '20px !important', overflow: 'hidden'}, marginY: 4, border: '0px', boxShadow: 'none', background: '#FFFBF8', '.css-o4b71y-MuiAccordionSummary-content': { margin: 0 } }}>
                <AccordionSummary
